...
double Vector3D::magnitude() const {
    ...
    // Fill in the blank.
    double result = sqrt(m_x * m_x + m_y * m_y + m_z * m_z);
...
Vector3D crossProduct(Vector3D& v1, Vector3D& v2) {
    Vector3D result = Vector3D(v1.m_y * v2.m_z - v1.m_z * v2.m_y, v1.m_z * v2.m_x - v1.m_x * v2.m_z, v1.m_x * v2.m_y - v1.m_y * v2.m_x);
