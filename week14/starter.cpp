...
public:
    ...
    float shootingSuccessRate(int base_skill) {
        ...
        float specialized_rate = base_rate * 0.8;
    ...
    float tackleSuccessRate(int base_skill) {
        ...
        float specialized_rate = base_rate * 1.5;
...
public:
    ...
    float shootingSuccessRate(int base_skill) {
        float base_rate = Player::shootingSuccessRate(base_skill);
        float specialized_rate = base_rate * 2;
    ...
    float tackleSuccessRate (int base_skill) {
        float base_rate = Player::tackleSuccessRate(base_skill);
        float specialized_rate = base_rate * 0.5;
...
int main() {
    ...
    Player* Minjae = new Defender("Minjae Kim");
    ...
    Player* Son = new Striker("Heungmin Son");
